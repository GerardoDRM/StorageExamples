...
public class MemeDatasource {
    ...
    public ArrayList<Meme> readMemes() {
        ...
        Cursor cursor = database.query(
                ...
                null, // group by
                null, // having
                MemeSQLiteHelper.COLUMN_MEME_CREATED_AT + " DESC"); // order by
        ArrayList<Meme> memes = new ArrayList<Meme>();
        if (cursor.moveToFirst()) {
            do {
                Meme meme = new Meme(getIntFroColumnName(cursor, BaseColumns._ID),
            ...
            if (cursor.moveToFirst()) {
                do{
                    MemeAnnotation annotation = new MemeAnnotation(
                            getIntFroColumnName(cursor, BaseColumns._ID),
                            ...
                            getIntFroColumnName(cursor, MemeSQLiteHelper.COLUMN_ANNOTATION_X),
                            getIntFroColumnName(cursor, MemeSQLiteHelper.COLUMN_ANNOTATION_Y));
    ...
    private int getIntFroColumnName(Cursor cursor, String columnName) {
    ...
    public void create(Meme meme) {
        ...
        memeValues.put(MemeSQLiteHelper.COLUMN_MEME_CREATED_AT, new Date().getTime());
